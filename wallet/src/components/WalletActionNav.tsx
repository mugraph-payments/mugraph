        ...
        {actions.map((action) => {
          ...
          return (
            <motion.button
              ...
              className={`wallet-interactive flex items-start gap-3 rounded-[1.25rem] border p-3.5 text-left ${
                action.isActive
            ...
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  <h3 className="wallet-heading text-sm font-semibold text-slate-50">
                    {action.label}
                  </h3>
