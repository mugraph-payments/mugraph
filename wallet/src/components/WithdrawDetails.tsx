        ...
        <ActionSummaryCard
          ...
          description={
            isEmpty
              ...
              : "Withdrawal prep keeps the most recent settlement reference, queue pressure, and active script context visible while notes are assembled for on-chain settlement."
          }
