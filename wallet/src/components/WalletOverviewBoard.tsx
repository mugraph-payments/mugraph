    ...
    <section className="wallet-card p-5">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0">
          ...
          <h3 className="wallet-heading mt-2 text-base font-semibold text-slate-50">
            {title}
          </h3>
        </div>
      </div>
            ...
            {topAssets.map((asset) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="wallet-data mt-2 text-sm font-semibold text-slate-100">
                    {asset.balanceLabel}
                  </p>
                </div>
          ...
          <div className="grid gap-3">
            {queueItems.map((item) => (
              ...
              >
                ...
                <p className="wallet-copy text-sm leading-6 text-slate-400">{item.summary}</p>
                <div className="flex items-center justify-between gap-3 text-sm text-slate-400">
