  ...
  return (
    <div className="mt-4 rounded-[1.5rem] border border-white/10 bg-white/[0.02] p-4">
      <p className="text-sm leading-6 text-slate-300">
        Share the active script address when funding {label}. The delegate
        context stays visible so incoming notes can be tied back to the correct
        issuer without exposing long identifiers in full.
      </p>

      <div className="mt-4 grid gap-3 sm:grid-cols-2">
        <DetailField label="Script address" value={scriptAddressShort} />
