     ...
     <div className="grid gap-3 sm:grid-cols-2">
      {[
       ...
       return (
        ...
        >
         <p className="wallet-heading text-base font-medium text-slate-100">{option.label}</p>
         <p className="wallet-copy mt-2 text-base leading-7 text-slate-400">{option.copy}</p>
        </button>
       );
      })}
     </div>
