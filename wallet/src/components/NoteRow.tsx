        ...
        <div className="min-w-0">
          ...
          <div className="mt-3 grid gap-3 sm:grid-cols-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-slate-100">{note.createdAtRelative}</p>
            </div>
            <div className="min-w-0">
              <p className="wallet-kicker text-slate-500">Nonce</p>
              <p className="wallet-code mt-1 truncate text-sm text-slate-100" title={note.nonceShort}>
                {note.nonceShort}
              </p>
            </div>
            <div className="min-w-0">
              ...
              <p
                className="wallet-code mt-1 truncate text-sm text-slate-100"
