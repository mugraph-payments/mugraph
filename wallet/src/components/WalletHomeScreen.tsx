        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_minmax(18rem,22rem)] xl:items-start">
          ...
          <div className="grid grid-cols-2 gap-3 xl:grid-cols-1 xl:self-center">
            <button
              ...
              className="wallet-interactive flex items-center justify-center gap-2 rounded-xl border border-teal-300/25 bg-teal-400/[0.08] px-4 py-3.5 text-base font-semibold text-teal-50 xl:justify-start xl:px-5 xl:py-3.5"
            >
            ...
            <button
              ...
              className="wallet-interactive flex items-center justify-center gap-2 rounded-xl border border-white/10 bg-white/[0.04] px-4 py-3.5 text-base font-semibold text-slate-50 xl:justify-start xl:px-5 xl:py-3.5"
            >
