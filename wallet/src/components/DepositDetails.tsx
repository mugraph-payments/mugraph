          ...
          <ActionSummaryCard
            ...
            description={
              isEmpty
                ...
                : "Deposit tracking keeps the funding target, delegate context, and latest on-chain deposit reference together while new notes move into the wallet inventory."
            }
