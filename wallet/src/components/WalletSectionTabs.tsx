    ...
    {sections.map((section) => {
     ...
     return (
      <button
       ...
       className={`wallet-interactive flex items-start gap-3 rounded-2xl border p-3 text-left ${
        isActive
      ...
      >
       ...
       <div className="min-w-0">
        ...
        <p className="wallet-heading mt-1 text-base font-semibold text-inherit">
         {section.label}
        </p>
        <p className="wallet-copy mt-1 text-base leading-7 text-inherit/75">
         {section.description}
        </p>
       </div>
      </button>
